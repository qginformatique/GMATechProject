namespace GMATechProject.Domain
{
    ...
    public interface IRepository<T> where T : IEntity
    {
		...
		/// <summary>
		/// Performs a quick search with the specified parameters.
		/// </summary> 
		/// <returns>
		/// The search results as a paginated list. 
		/// </returns>
		/// <param name='query'>
		/// The query terms.
		/// </param>
		...
		/// Page size.
		/// </param>
		PaginatedList<T> QuickSearch(string query, int pageIndex = 0, int pageSize = 10);
	}
}
