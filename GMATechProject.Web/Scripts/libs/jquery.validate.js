...
$.extend($.validator, {
	...
	prototype: {
		...
		elements: function() {
			...
			.not(":submit, :reset, :image, [disabled], .ui-autocomplete-input, .cke_contents_ltr")
...
}, "Please provide a valid euro amount (up to 2 decimal places) and do not include the currency symbol.");
